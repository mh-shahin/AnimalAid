    ...
    useEffect(() => {
        const fetchMedicineDetails = async () => {
            try {
                ...
                setMedicine(data);
                // Assuming reviews are part of the medicine data
                if (data.reviews) {
                ...
                <div className="md:w-2/3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        <div>
                            ...
                            <p className="text-sm text-gray-900">{medicine.discount} %</p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-900">{medicine.brand}</p>
                        </div>
                        <div>
                            <h3 className="text-sm font-medium text-gray-500">Packet Size</h3>
                            <p className="text-sm text-gray-900">{medicine.quantity} {medicine.unit}</p>
                        </div>
                    </div>
