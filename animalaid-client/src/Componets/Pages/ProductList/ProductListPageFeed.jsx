...
import ProductCard from "../../Shared/ProductCard/ProductFeedCard.jsx";

const ProductListPageFeed = () => {
  const [products, setProducts] = useState([]);
  const [loading, setLoading] = useState(true);

  // Replace this URL with your real API endpoint
  const API_URL = "http://127.0.0.1:8000/feeds"; 
  useEffect(() => {
    let mounted = true;
...
export default ProductListPageFeed;
